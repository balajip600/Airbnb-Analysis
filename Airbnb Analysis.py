...
st.set_page_config(page_title="AirBnb-Analysis by SHAKTHI SIVANI G", page_icon=":bar_chart:", layout="wide")
...
if SELECT == "Contact":
    Name = (f'{"Name :"}  {"SHAKTHI SIVANI G"}')
    mail = (f'{"Mail :"}  {"gshakthisivani@gmail.com"}')
...
with col1:
        image = Image.open("C:/Users/Ganesh Babu/Downloads/siva.jpg")
